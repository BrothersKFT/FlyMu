	...
	if (gProtect.m_MainInfo.RankUserShowOverHead != 0)
	{
		if (gProtect.m_MainInfo.RankUserType == 5)
		{
			...
			switch (this->m_Data[index].m_PKLevel)
			{
				//===============================================================================
			case 0:
				CFont.SetFontColor(0, 255, 255, 255);
				CFont.CUIPaintFont((float)PosX + 40, (float)PosY + 5, name, 0, 8);
				break;
				//===============================================================================
			case 1:
				CFont.SetFontColor(36, 242, 252, 255); // azul
				CFont.CUIPaintFont((float)PosX + 40, (float)PosY + 5, name, 0, 8);
				break;
				//===============================================================================
			case 2:
				...
				//===============================================================================	
			case 3:
				CFont.SetFontColor(255, 255, 0, 255); // amarillo
				CFont.CUIPaintFont((float)PosX + 40, (float)PosY + 5, name, 0, 8);
				break;
				//===============================================================================
			case 4:
				CFont.SetFontColor(255, 105, 25, 255); // naranja
				CFont.CUIPaintFont((float)PosX + 40, (float)PosY + 5, name, 0, 8);
				break;
				//===============================================================================	
			case 5:
				CFont.SetFontColor(255, 0, 0, 255); // rojo
				CFont.CUIPaintFont((float)PosX + 40, (float)PosY + 5, name, 0, 8);
				break;
				//===============================================================================	
			case 6:
